...
- **Build pipeline**: see [`BUILD_PIPELINE.md`](BUILD_PIPELINE.md) — how to build the V1 ES feature panel end-to-end
- **Feature catalog**: see [`FEATURES.md`](FEATURES.md) — what each feature means
